...
.page{min-height:100dvh;width:100vw;background:#000;padding:0;overflow:hidden}
.frame{width:100vw;max-width:none;height:100dvh;min-height:100dvh;margin:0;border:1px solid #8f0907;border-radius:0;background:#030303;overflow:hidden;box-shadow:0 0 38px rgba(150,0,0,.42);display:flex;flex-direction:column}
...
.content{display:grid;grid-template-columns:minmax(350px,420px) minmax(0,1fr);gap:clamp(8px,1vw,14px);padding:0 clamp(8px,1.2vw,18px) clamp(8px,1vw,14px);flex:1;min-height:0;height:100%;overflow:hidden}
...
footer{margin:0 clamp(8px,1.2vw,18px) clamp(6px,.8vw,10px);border:1px solid #242424;border-radius:8px;background:#050505;color:#d0d0d0;text-align:center;padding:10px;font-family:'Rye',Georgia,serif;font-size:clamp(9px,.85vw,12px);letter-spacing:.18em;text-transform:uppercase;flex:0 0 auto}
